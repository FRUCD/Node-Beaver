...
silent only
cd /cygdrive/c/Users/Jonathan/My\ Documents/PSoC\ Creator/Node-Beaver/Node-Beaver/Node-Beaver.cydsn
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 25 + 44) / 88)
exe 'vert 1resize ' . ((&columns * 85 + 135) / 271)
exe '2resize ' . ((&lines * 59 + 44) / 88)
exe 'vert 2resize ' . ((&columns * 85 + 135) / 271)
exe '3resize ' . ((&lines * 25 + 44) / 88)
exe 'vert 3resize ' . ((&columns * 185 + 135) / 271)
exe '4resize ' . ((&lines * 59 + 44) / 88)
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 29 + 44) / 88)
exe 'vert 1resize ' . ((&columns * 96 + 135) / 271)
exe '2resize ' . ((&lines * 55 + 44) / 88)
exe 'vert 2resize ' . ((&columns * 96 + 135) / 271)
exe 'vert 3resize ' . ((&columns * 174 + 135) / 271)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 28 - ((27 * winheight(0) + 42) / 85)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
28
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 86 - ((85 * winheight(0) + 43) / 86)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
86
