...
*
*  M_MOSI_DM_STRONG     Strong Drive 
*  M_MOSI_DM_OD_HI      Open Drain, Drives High 
*  M_MOSI_DM_OD_LO      Open Drain, Drives Low 
*  M_MOSI_DM_RES_UP     Resistive Pull Up 
*  M_MOSI_DM_RES_DWN    Resistive Pull Down 
*  M_MOSI_DM_RES_UPDWN  Resistive Pull Up/Down 
*  M_MOSI_DM_DIG_HIZ    High Impedance Digital 
*  M_MOSI_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
